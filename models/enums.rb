...
module DASHPANEL_TYPE
	...
	MY_WNO_TESTS = 3
	MY_WNO_TESTS_RT = 4
	UNASSIGNED_NEW_ALL = 5

	## Require a RT - 1x ##
	STATUS_NEW_AND_INPROG = 11
	UNASSIGNED_NEW_RT = 12
	STATUS_PASSED = 14
	STATUS_FAILED = 15
	ALL_APPS = 16
	APPS_WNO_TESTS = 17
...
NON_RT_DASHPANELS = [DASHPANEL_TYPE::MYACTIVE,DASHPANEL_TYPE::MY_WNO_TESTS,DASHPANEL_TYPE::MY_PASSED,DASHPANEL_TYPE::MY_FAILED,DASHPANEL_TYPE::MY_ALL,DASHPANEL_TYPE::MY_APPROVALS,DASHPANEL_TYPE::UNASSIGNED_NEW_ALL];
